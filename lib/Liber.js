  ...
  var addViewGetter = Liber.addViewGetter = function (Class, name, attrs) {
    if (isArray(attrs)) {
      ...
      Class[['get', name].join('')] = function () {
        this.getFromView.apply(this, concat(attrs, arguments));
      };
      Class[['getOne', name].join('')] = function () {
        this.getOneFromView.apply(this, concat(attrs, arguments));
      };
    } else {
      throw new Error('Getters are generated from array of attributes.');
    }
  };
